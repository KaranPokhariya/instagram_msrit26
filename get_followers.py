...
options.add_extension("/Users/karansingh/Downloads/instagram_msrit26/extension.crx")
...
username.clear()
username.send_keys("svcdelhi_confessions")
password.clear()
password.send_keys("IGisToXIC22@")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/karansingh/Downloads/{}_followers.csv /Users/karansingh/Downloads/instagram_msrit26/accounts'.format(account))
        except:
